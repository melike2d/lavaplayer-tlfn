...
public class SoundCloudAudioSourceManager implements AudioSourceManager, HttpConfigurable {
  ...
  private static final String GOOGLE_TRACK_URL_REGEX = "^(?:http://|https://|)(?:www\\.|)(?:m\\.|)soundcloud\\.app\\.goo\\.gl/([a-zA-Z0-9-_]+)$";
  ...
  private static final Pattern googleTrackUrlPattern = Pattern.compile(GOOGLE_TRACK_URL_REGEX);
  ...
  private AudioTrack processAsSingleTrack(AudioReference reference) {
    ...
    Matcher googleTrackUrlMatcher = googleTrackUrlPattern.matcher(url);
